...
public class RecordFactoryImpl implements RecordFactory {
   ...
   */
  public RecordFactoryImpl(String targetName, Map<String, String> typeMap) {
    this.targetName = targetName;
    this.typeMap = typeMap;
    targetDictionary = new Dictionary();
  }

  public RecordFactoryImpl(String targetName, String idName, Map<String, String> typeMap) {
   ...
   */
  @Override
  public RecordFactoryImpl maxTargetValue(int max) {
    maxTargetValue = max;
    return this;
  }
  ...
  public void firstLine(String line) {
    ...
    configVariableNames(Lists.newArrayList(COMMA.split(line)));
  }
  
  public void configVariableNames(List<String> names) {
    // read variable names, build map of name -> column
    variableNames = names;
  ...
  public int processLine(String line, Vector featureVector) {
    ...
    return processData(values, featureVector) ;
  }

  public int processData(List<String> values, Vector featureVector) {
  ...
  @Override
  public Map<String, Set<Integer>> getTraceDictionary() { return traceDictionary; }

  @Override
  public RecordFactoryImpl includeBiasTerm(boolean useBias) {

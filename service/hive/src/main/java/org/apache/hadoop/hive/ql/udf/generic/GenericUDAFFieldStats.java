 ...
 *
 */
@Description(name = "field_stats",
value = "_FUNC_(x) - Returns the statistical summary of a set of primitive type values.")
public class GenericUDAFFieldStats extends AbstractGenericUDAFResolver {

  static final Log LOG = LogFactory.getLog(GenericUDAFFieldStats.class.getName());
  ...
  public static class GenericUDAFBooleanStatsEvaluator extends GenericUDAFEvaluator {
    ...
    public ObjectInspector init(Mode m, ObjectInspector[] parameters) throws HiveException {
      ...
      if (mode == Mode.PARTIAL1 || mode == Mode.COMPLETE) {
        ...
        columnTypeFieldOI = (WritableStringObjectInspector) columnTypeField.getFieldObjectInspector();

...
public class LRLearnerSettings {
  ...
  public LRLearnerSettings() {}
  
  public LRLearnerSettings(NodeSettingsRO settings) throws InvalidSettingsException {
  ...
  public void merge(LRLearnerSettings other) {

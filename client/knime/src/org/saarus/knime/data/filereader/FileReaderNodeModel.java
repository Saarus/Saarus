...
public class FileReaderNodeModel extends NodeModel {
   ...
   * if the filename ends with ".xml", or set the specified file table as
   * default data file table for the configuration dialog. Settings in the
  ...
  public FileReaderNodeModel(final NodeCreationContext droppedFile) {
    this();
    m_frSettings = new FileReaderNodeSettings();
    m_frSettings.setDataFileLocationAndUpdateTableName(droppedFile.getUrl());
  }
  ...
  protected BufferedDataTable[] execute(final BufferedDataTable[] data,
    ...
    BufferedDataContainer c =
        exec.createDataContainer(fTable.getDataTableSpec(), /*initDomain=*/true);
    int row = 0;
   ...
   *         <code>null</code>.
   */
  FileReaderSettings getFileReaderSettings() { return m_frSettings;}
  ...
  protected void saveSettingsTo(final NodeSettingsWO settings) {
    ...
    if (s == null) s = new FileReaderNodeSettings();

...
public class XMLPropsReader extends XMLProperties {
    ...
    public String getColumnMissing(final int index) {
        ...
        // finally return DataCell with value of attribute "table"
    ...
    /**
     * Returns column table at index.
     * 
     * @param index in column header.
     * @return column table at index.
     * 
    ...
    public String getColumnName(final int index) {
        ...
        // finally return DataCell with value of attribute "table"
        return getAttributeValue(indexNode, "table");
    }
    ...
    /**
     * Returns an URL of the input data file initialized with file table,

...
public class CharsetNamePanel extends JPanel {
    ...
    // action command for the "enter your own char set table" button
    ...
    /**
     * Creates a panel to select the character set table and initializes it from
     * the passed object.
     * 
    ...
    private Container getSelectionPanel() {
        ...
        m_custom.setToolTipText("Enter a valid charset table supported by "
    ...
    /**
     * Tests the entered charset table (if the textfield is enabled), and colors
     * the textfield in case of an error.
     * 
     * @return true if the entered charset table is supported or the textfield is
     *         disabled.
     */
            ...
            if (b.isSelected()) {
                ...
                if (CUSTOM_LABEL.equals(b.getActionCommand())) {
                    if ((m_custom.getText() == null)
                        ...
                        return "Please enter a character set table";
                    }
                    if (!checkCustomCharsetName()) {
                        return "The entered character set table is not supported"
                                + " by this Java VM";
                    }
                }
                break;

...
public class VNWordNumberTokenAnalyzer implements TokenAnalyzer {
  ...
  private double getUnitValue(String unit){
    ...
    if(StringUtil.isIn(unit, new String[]{"mư�?i", "mươi", "muoi", "chục"})) return 10;

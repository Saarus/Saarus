...
public class PhoneNumberUtil {
  ...
  final static public String getAreaName(String string) {
    if(string.length() == 9 || string.length() == 10){
      ...
      if(string.startsWith("056")) return "Bình �?ịnh" ;
      ...
      if(string.startsWith("511")) return "�?à Nẵng" ;
      if(string.startsWith("051")) return "�?à Nẵng" ;
      if(string.startsWith("050")) return "�?ắk Lắk / �?ắk Nông" ;
      if(string.startsWith("023")) return "�?iện Biên" ;
      if(string.startsWith("061")) return "�?ồng Nai" ;
      if(string.startsWith("067")) return "�?ồng Tháp" ;
      ...
      if(string.startsWith("063")) return "Lâm �?ồng" ;
      if(string.startsWith("072")) return "Long An" ;
      if(string.startsWith("350")) return "Nam �?ịnh" ;
      ...
      if(string.startsWith("210")) return "Phú Th�?" ;
      ...
      if(string.startsWith("073")) return "Ti�?n Giang" ;

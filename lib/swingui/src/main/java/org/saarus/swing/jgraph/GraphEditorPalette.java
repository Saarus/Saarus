...
public class GraphEditorPalette extends JPanel {
  ...
  public void setSelectionEntry(JLabel entry, mxGraphTransferable t) {
    ...
    if (selectedEntry != null) {
      selectedEntry.setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED));
  ...
  public void addTemplate(final String name, ImageIcon icon, mxCell cell) {
    ...
    entry.setBackground(GraphEditorPalette.this.getBackground().brighter());
